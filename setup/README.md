...
- installs the npm-distributed agent tooling (Codex, Pi, `skills`, `gnhf`, `gh-axi`, `chrome-devtools-axi`, `lavish-axi`, `tasks-axi`, `no-mistakes`) and registers the AXI-family skills globally
- clones or fast-forwards the [First Mate](https://github.com/kunchenguid/firstmate) checkout under `~/github/firstmate`
